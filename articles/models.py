...
class Article(models.Model):
    ...
    # id = models.AutoField(primary_key=True) -> Integer 값이 자동으로 하나씩 증가(AUTIINCREMENT)
    ...
    # )
    # DateTimeField
    #   auto_now_add : 생성시 자동으로 저장 (한 번)
    #   auto_now : 수정시마다 자동으로 저장
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    
    user = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE)    # 참조 : https://docs.djangoproject.com/en/2.2/topics/auth/customizing/
